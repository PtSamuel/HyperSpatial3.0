  ...
  getLocation() {
    ...
    wx.getLocation({
      ...
      success: function(res){
        ...
        var coords = that.locations["Gates-Hillman"];
        ...
        var dem = costheta*(cosphi**3) + ((sintheta*cosphi)**2) + sinphi**2
        var inv = [
          [-sintheta/dem, costheta*(sinphi**2) + cosphi**3, sintheta*(cosphi-sintheta)*sintheta*costheta],
          [-costheta*sinphi/dem, -sintheta*sinphi, (costheta*cosphi+sintheta**2)*cosphi],
          [costheta*cosphi/dem, sintheta*sinphi, sinphi]
        ]
        ...
        var factors = [3, 6, -5]
        trans = [
          x_local[0] * factors[0] + y_local[0] * factors[1] + z_local[0] * factors[2],
          x_local[1] * factors[0] + y_local[1] * factors[1] + z_local[1] * factors[2],
          x_local[2] * factors[0] + y_local[2] * factors[1] + z_local[2] * factors[2]
        ]
        console.log("factors:", factors, "computed:", [
          inv[0][0] * trans[0] + inv[0][1] * trans[1] + inv[0][2] * trans[2],
          inv[1][0] * trans[0] + inv[1][1] * trans[1] + inv[1][2] * trans[2],
          inv[2][0] * trans[0] + inv[2][1] * trans[1] + inv[2][2] * trans[2]
        ])
